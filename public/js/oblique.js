/* =========================================================
   oblique.js
   Eno + Schmidt — Oblique Strategies (1975).
   Used as the daily idle prompt on the homepage when no
   trip is active. Surfaced one-per-day (deterministic by
   date) so the same prompt shows all day.
   ========================================================= */
